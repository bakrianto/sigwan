    ...
    <div id="navbar" class="navbar-collapse collapse center">
        <div class="container">
            <ul class="nav navbar-nav">
                ...
                <li>
                <a href="index.php?pg=puskeswan"> Data Puskeswan</a>
                </li>
                <li>
                <a href="index.php?pg=dokter"> Data Dokter</a>
                </li>
                <li>
                <a class="show" href="index.php?pg=toko"> Data Toko Obat</a>
                </li>
                <li>
                <a class="show" href="index.php?pg=kecamatan"> Kecamatan</a>
                </li>
                <li>
